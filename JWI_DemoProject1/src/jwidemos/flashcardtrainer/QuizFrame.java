...
public class QuizFrame extends JFrame
	...
	private void setupPullDownMenus() /* implementsintention PullDownMenus, OpenFlashcardSetThroughFileMenu */ {
		...
		*/
		...
		/*
		[[ 3 | Add the File and Help menus to the menu bar ]]
		*/       
	...
	private void setupDataEntryPane() /* implementsintention BasicScreenLayout */ {
		...
		/*
		[[ 1 | Create three panels (1. the status panel at the top, 2. the input panel at
		...
		*/
		...
		/*
		[[ 2 | Set up the status panel at the top of the window ]]
        */
        ...
        */
		...
		/*
		[[ 3 | Add the cue, answer, and result fields and labels to the input panel,
        ...
        */
		...
		/*
        [[ 3.1 | Insert the "cuePanelText" component into the "cuePanel" panel.
		...
		*/
		...
		/*
		[[ 4 | Add control buttons to the control panel ]]
		*/
	...
	public void handleCorrectAnswer(String answerText, DefaultListModel acceptableAnswers) {
		...
		/* [[ 1 | Color field backgrounds green, display the text "Correct!", and
		...
		/* [[ 2 | Temporarily disable the "Answer" field ]] */
		disableAnswerField();
		/* [[ /2 ]] */

		/* [[ 3 | Enable the "Next" button and switch the focus to that button ]] */
		nextButton.setEnabled(true);
		nextButton.requestFocus();
		/* [[ /3 ]] */

		/* [[ 4 | Refresh the status panel (updates the count of flashcards presented so far) ]] */
		refreshStatusPanel();
		setVisible(true);
		/* [[ /4 ]] */
	}
	...
	public void handleIncorrectAnswer(String answerText, DefaultListModel acceptableAnswers) {
		...
		/* [[ 1 | Color field backgrounds red, display the text "Incorrect...", and
                  display the list of acceptable answers ]] */
		...
		/* [[ 2 | Detach the "answerFieldListener" from the "answerField" component, so the
	...
	private void refreshStatusPanel() {
		...
		/*
		[[ 1 | Display the "Presentation" counter; the presentation number is based on the
...
class ExtensionFilter extends FileFilter /* implementsintention OpenFlashcardSetThroughFileMenu, FlashcardSetFilesHaveFCSExtension */ {
